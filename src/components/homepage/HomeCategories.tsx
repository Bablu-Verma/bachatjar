  ...
  return (
    <>
      <div className="max-w-6xl mx-auto pt-2 mb-4">
       ...
       <div className="flex justify-start items-start flex-wrap px-2 gap-4 sm:gap-5">
...

      {
        ...
        <div className="bg-gray-300 p-4 mx-2 relative rounded-lg shadow-md min-h-[500px] max-h-[80vh] overflow-auto w-full max-w-6xl">
          <button title="close" className=' absolute top-5 right-4 bg-white p-1  rounded-full' onClick={()=>setOpendrawer(false)}><IoMdClose className="text-lg text-primary" /></button>
